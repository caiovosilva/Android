...
public class MainActivity extends AppCompatActivity implements LocationListener {
    ...
    public void salvarProduto_Click(View v){
        setContentView(R.layout.create_product);
        EditText nome =(EditText) findViewById (R.id.txtNome);
        EditText preco =(EditText) findViewById (R.id.txtPreco);


        persistir_Produto(nome.getText().toString(), Double.parseDouble(preco.getText().toString()));
    }

    private void persistir_Produto(String nome, double preco){
        db.execSQL("INSERT INTO produtos(nome, preco) VALUES(nome, preco)");
        db.execSQL("INSERT INTO produtos(nome, preco) VALUES('Redd Bull', '6.50')");
